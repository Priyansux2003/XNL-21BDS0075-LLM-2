...
wandb.init(project="llm-testing-validation")
...
def compute_metrics(eval_pred):
    """Compute accuracy, precision, recall, F1-score, and additional evaluation metrics."""
...
def objective(trial):
    ...
    # Additional evaluation step for robustness
    cross_val_scores = compute_metrics(eval_result)
    wandb.log(cross_val_scores)
